...
class Programa(db.Model):
    ...
    __table_args__ = {'schema': 'spo_sistemanger'}
...
class Acao(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    programa_id = db.Column(db.Integer, db.ForeignKey('spo_sistemanger.programa.id'))
...
class ProdutoAcao(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    acao_id = db.Column(db.Integer, db.ForeignKey('spo_sistemanger.acao.id'), nullable=False)
...
class SubacaoEntrega(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    produto_id = db.Column(db.Integer, db.ForeignKey("spo_sistemanger.produto_acao.id"), nullable=False)
...
class MunicipioEntrega(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    subacao_entrega_id = db.Column(db.Integer, db.ForeignKey('spo_sistemanger.subacao_entrega.id'), nullable=False)
...
class MemoriaCalculo(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    etapa_id = db.Column(db.Integer, db.ForeignKey("spo_sistemanger.etapa.id"), nullable=False)
